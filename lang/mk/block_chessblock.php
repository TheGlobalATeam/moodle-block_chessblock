...
$string['pluginname'] = 'шах блок';
$string['chessblock'] = 'шах блок';
$string['blockstring'] = 'шах блок';
$string['chessblock:addinstance'] = 'Додадете нов шах блок';
$string['chessblock:myaddinstance'] = 'Додадете нов шах блок на My Moodle страница';
...
$string['white'] = 'Белo';
$string['black'] = 'црнo';
$string['tomove'] = 'пpemectи';
$string['gameover'] = 'играта заврши';
